...
<template>
  <div class="flex flex-col gap-6 p-4 sm:p-6 max-w-7xl mx-auto w-full">
    ...
    <div v-else-if="!user" class="flex flex-col items-center justify-center py-12 text-muted-foreground bg-muted/30 rounded-lg border border-dashed">
      ...
      <p class="mb-4">
        The employee with ID {{ userId }} does not exist or you don't have permission to view them.
      </p>
            ...
            <CardContent class="space-y-6">
              <div class="grid sm:grid-cols-2 gap-x-8 gap-y-4">
                <div class="space-y-1">
                  ...
                  <p class="text-sm font-medium font-mono bg-muted/50 px-2 py-1 rounded w-fit">
                    {{ user._id || user.id }}
                  </p>
                </div>
              ...
              <div>
                <h4 class="text-sm font-medium mb-3">
                  Associated Locations / Addresses
                </h4>
