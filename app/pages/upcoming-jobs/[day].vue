...
const _currentDayDate = computed(() => {
  if (day.value === 'day-offs')
    return ''
...
function generateDummyJobs(count: number) {
            ...
            <div class="p-4 pb-3">
              <div class="flex items-start justify-between gap-3">
                ...
                <div class="text-right shrink-0">
                  ...
                  <p class="text-lg font-black text-primary tabular-nums">
                    {{ job.estimate }}
                  </p>
                </div>
              </div>
            ...
            <div class="mx-4 mb-3 grid grid-cols-2 gap-3 rounded-lg bg-muted/40 p-3 ring-1 ring-border/30">
              <div>
                ...
                <p class="text-sm font-semibold mt-0.5">
                  {{ formatTime(job.fromDate) }} — {{ formatTime(job.toDate) }}
                </p>
              </div>
              <div>
                <p class="text-[10px] font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1">
                ...
                <p class="text-sm font-semibold mt-0.5 truncate" :title="job.jobLocation">
                  {{ job.jobLocation }}
                </p>
              </div>
            </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center gap-2">
                  <Avatar class="size-7 border">
                    <AvatarFallback class="text-[10px] bg-primary/10 text-primary font-bold">
                      {{ getInitials(job.projectManager) }}
                    </AvatarFallback>
                  </Avatar>
                  <div class="min-w-0">
                ...
                <div class="flex items-center gap-2">
                  <Avatar class="size-7 border">
                    <AvatarFallback class="text-[10px] bg-secondary/50 font-bold">
                      {{ getInitials(job.foremanName) }}
                    </AvatarFallback>
                  </Avatar>
                  <div class="min-w-0">
                    <p class="text-xs font-semibold leading-none truncate">
