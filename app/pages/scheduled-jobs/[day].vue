          ...
          >
            ...
            <div class="mx-4 mb-3 grid grid-cols-2 gap-3">
                ...
                <div v-if="job.projectManagerName" class="flex items-center gap-2">
                  <Avatar class="size-7 border">
                    ...
                    <AvatarFallback class="text-[10px] bg-primary/10 text-primary font-bold">
                      {{ getInitials(job.projectManagerName) }}
                    </AvatarFallback>
                  </Avatar>
                  <div class="min-w-0">
                ...
                <div v-if="job.foremanDisplayName" class="flex items-center gap-2">
                  <Avatar class="size-7 border">
                    ...
                    <AvatarFallback class="text-[10px] bg-secondary/50 font-bold">
                      {{ getInitials(job.foremanDisplayName) }}
                    </AvatarFallback>
                  </Avatar>
                  <div class="min-w-0">
                    <p class="text-xs font-semibold leading-none truncate">
                      {{ job.foremanDisplayName }}
                    </p>
                    <p class="text-[10px] text-muted-foreground">
                      Foreman
                    </p>
              ...
              <div v-if="job.assigneeDetails && job.assigneeDetails.length > 0" class="space-y-2">
                <p class="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  Crew ({{ job.assigneeDetails.length }})
                </p>
                <div class="flex -space-x-2">
